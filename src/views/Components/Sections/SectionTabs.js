                      ...
                      <div>
                        <GridContainer className="inputs">
                          <GridItem xs={12} sm={12} md={12} lg={12}>
                            ...
                            <p className={classes.textCenter}>
                              Must be a forward‑facing, centered photo including
                              the driver’s full face and top of shoulders, with
                              no sunglasses. Must be a photo only of the
                              applicant with no other subject in the frame,
                              well‑lit, and in focus. It cannot be an
                              applicant’s CNIC photo or other printed photograph
                            </p>
                        ...
                        <GridContainer className="inputs">
                          <GridItem xs={12} sm={12} md={12} lg={12}>
                            <h2>Applicant’s documents</h2>
                            <p>
                              A valid National ID Card (Front & Back). Also a
                              Valid CNIC of one of the parent.
                            </p>
                            <Input type="file" name="file" id="exampleFile" />
                          </GridItem>
                        </GridContainer>
