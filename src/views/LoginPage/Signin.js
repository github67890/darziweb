...
export default function LoginPage(props) {
  ...
  useEffect(() => {
    fetch("https://darzieverywhere.herokuapp.com/api/users/login/")
...
const logName = async() => {
    ...
    if (isValidmail && isValidpass) {
      ...
      const response= await fetch("https://darzieverywhere.herokuapp.com/api/users/login", {
        method: "post",
        headers: {
